...
CREATE TABLE "lens_catalog_items" (
	...
	"base_features" json,
	"is_photochromic" boolean NOT NULL,
...
ALTER TABLE "products" ADD CONSTRAINT "products_supplier_id_fkey" FOREIGN KEY ("supplier_id") REFERENCES "public"."suppliers"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "ix_users_username_lower" ON "users" USING btree (lower((username)::text) text_ops);
*/