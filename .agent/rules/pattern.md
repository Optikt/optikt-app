...
- Iconos de @lucide/svelte. Importación explícita, nunca barrels
...
- El código compartido debe vivir en carpetas claras como `components`, `layouts`, `lib` o `utils`. Utiliza las carpetas de `shared` si se pueden utilizar en el server y cliente
