...
>
	...
	<footer
		class="receipt-footer flex items-end justify-between gap-4 border-t-[0.5px] border-[#eee] pt-2"
	>
		...
		<div class="text-center">
			...
			<p class="text-[9px] tracking-[0.04em] text-slate-400">Firma del cliente</p>
		</div>
	</footer>
</article>
