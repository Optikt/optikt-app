...
<Modal bind:open size="lg" title="Sugerencias de Precio" permanent>
	<div class="space-y-4">
	...
	<div class="mt-6 flex items-center justify-between">
		...
		<div class="flex gap-2">
			<Button color="light" onclick={onSkip} disabled={loading}>Omitir</Button>
			<Button color="blue" onclick={handleApply} disabled={loading || selectedCount === 0}>
