...
- ✅ **IVA básico (Fase 7)** — tax-inclusive pricing, desglose fiscal en ventas/presupuestos
- ✅ **FIFO Inventory** — lotes, movimientos inmutables, costo FIFO, weighted average cost, ajustes manuales
...
| RT-4 | ~~Fallback para errores de validación no vinculados a campos visibles~~ — **RESUELTO**: `toastUnboundErrors()` implementado en 13 form components + mensajes Zod custom en español                                                                                                                                                    | ~~Alto~~ ✅ |
